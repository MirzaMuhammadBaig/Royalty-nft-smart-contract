...
contract Antematter is ERC721, Ownable {
    ...
    constructor(uint256 _totalSupply, uint256 _price, address address_of_USDT_contract) ERC721("Antematter", "AM") {
    ...
    function safeMint(address to) public {
        ...
        require(USDT.allowance(msg.sender, address(this)) >= price,"Insufficient allowance");
